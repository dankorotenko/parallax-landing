...
const contactInput = document.querySelector<HTMLElement>("#email");

// fake sending email to api endpoint
function postEmailToDatabase(email: string): Promise<void> {
...
// FADE UP OBSERVER
function fadeUpObserverCallback(elsToWatch: any): void {
  elsToWatch.forEach((el: any) => {
